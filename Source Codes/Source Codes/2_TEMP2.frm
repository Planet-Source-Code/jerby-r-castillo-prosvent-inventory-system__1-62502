...
Timer2.Interval = 100
 cmbCust.ListIndex = -1
    Call CMB1("Supplier", "BusinessName", cmbCust, "Where suppliersid<>'CASH'")
...
Set Rs1 = New Recordset
SQL = "Select TOP 20 *,(UnitsInStock + UnitsInOrder) as Total from PRODUCT where (PRODUCTID='" & Text4 & "' OR NAME like'" & Text4 & "%')"
Set Rs1 = DCON.Execute(SQL)
 Set RS2 = New Recordset
