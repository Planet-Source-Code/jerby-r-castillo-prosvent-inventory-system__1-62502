...
Begin VB.Form Form1 
   ...
   Begin VB.Image Image1 
      Height          =   720
      Left            =   0
      Picture         =   "frmTestPayment.frx":0000
      Stretch         =   -1  'True
      Top             =   0
      Width           =   4530
   End
...
Case "SalesRegistry"
    SQL = "Select * from SalesRegistryHeader where CustomersID='" & cmbtitle & "'"
...
SQL = "Select * from SalesRegistryHeader where (SalesRegistryID='" & CustID & "') And [date] between #" & DTPicker1.Value & "# AND #" & DTPicker2.Value & "#"
Call frmControlMain.CreateDataPage(SQL, "Sales Registry Information")
...
Call CMB3("SalesRegistryHeader", "CustomersID", cmbtitle, , True)
