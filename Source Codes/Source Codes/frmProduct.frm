...
Set Rs1 = New Recordset
Set Rs1 = DCON.Execute("Select * from product where name='" & txtname.text & "'")
...
CDb.TableName = "Product"
CDb.ClauseStatement = "Where ProductID='" & MODIFYID & "'"
...
Set CUpd = Nothing
    ...
    Else
            ...
            If Rs1!customeriD <> MODIFYID Then
...
Set Rs1 = New Recordset
Set Rs1 = DCON.Execute("Select * from Product where SerialNumber='" & txtserial.text & "' Or Name='" & txtname.text & "'")

If Rs1.RecordCount = 0 Then

Call GetNewConnection(CIns)
Set CDb = CIns
ProdID = CIns.AUTONUM(CDb.OpenDb, "Product", "ProductID", "PRD")
...
Call GetNewConnection2
Set Rs1 = New Recordset
Set Rs1 = DCON.Execute("Select * from category where category='" & cmbcat.text & "'")
...
Set Rs1 = New Recordset
Set Rs1 = DCON.Execute("Select * from location where location='" & cmblocation.text & "'")

If Rs1.RecordCount = 0 Then

    DCON.Execute "Insert into location(location) values('" & cmblocation.text & "')"
...
If ADDING = False Then
    Call GetNewConnection2
    Set Rs1 = New Recordset
    Set Rs1 = DCON.Execute("Select * from Product where ProductID='" & MODIFYID & "'")

    If Rs1.RecordCount <> 0 Then
        txtname.text = Rs1!Name & " "
        txtserial.text = Rs1!SerialNumber & " "
        cmbcat.text = Rs1!category & " "
        cmblocation.text = Rs1!LocationID & " "
        txtstock.text = Rs1!UnitsInStock & " "
        txtqty.text = Rs1!ReorderQuantity & " "
        txtlevel.text = Rs1!ReorderLevel & " "
        txtcost.text = Rs1!UnitCostPrice & " "
        txtselling.text = Rs1!UnitSellingPrice & " "
...
Private Sub Form_Load()
    ...
    Call CMB1("Category", "Category", cmbcat)
    Call CMB1("Location", "location", cmblocation)
